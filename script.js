...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function displayQuotes(type) {
        const quoteList = document.getElementById('quoteList');
        quoteList.innerHTML = '';  // Nettoie la liste précédente

        const citations = citationsData[type];
    ...
    // Appelle la fonction pour afficher les citations de type1 au chargement
    displayQuotes('type1');
});
